...
const generateRandomTransactionHistory = (count) => {
  const history = [];
  const stockNames = ['台積電', '聯發科', '鴻海', '廣達', '台達電', '中華電', '富邦金', '國泰金', '中信金', '兆豐金', '統一', '台塑', '南亞', '台化', '長榮', '陽明', '萬海', '華航', '長榮航', '友達', '群創', '聯電', '世界先進', '日月光投控', '矽力-KY', '譜瑞-KY', '祥碩', '力旺', 'M31', '創意'];
  const stockSymbols = ['2330', '2454', '2317', '2382', '2308', '2412', '2881', '2882', '2891', '2886', '1216', '1301', '1303', '1326', '2603', '2609', '2615', '2610', '2618', '2409', '3481', '2303', '5347', '3711', '6415', '4966', '5269', '3529', '6643', '3443'];
  const transactionTypes = ['買入', '賣出'];
  ...
  for (let i = 0; i < count; i++) {
    ...
    const shares = Math.floor(Math.random() * 100) * 100 + 100; // 100 to 10000 shares, in multiples of 100
    const price = parseFloat((Math.random() * 500 + 50).toFixed(2)); // 50 to 550
    const amount = shares * price;

    // Generate date from 2025-08-01 to 2026-06-30
...
export const demoPortfolio = {
  ...
  transactionHistory: generateRandomTransactionHistory(80),
};
